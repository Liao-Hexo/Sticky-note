...
struct Color {
    static let red = UIColor(red: 0.80, green: 0.31, blue: 0.31, alpha: 1.00)
    static let dark = UIColor(red: 0.10, green: 0.11, blue: 0.13, alpha: 1.00)
    static let grey = UIColor(red: 0.93, green: 0.93, blue: 0.93, alpha: 1.00)
