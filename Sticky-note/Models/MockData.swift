...
struct CategoryType{
    ...
    static let data = [
        ...
        CategoryType(title: "✈️ Travel & Tourism"),
        CategoryType(title:"🍿 Movies"),
        CategoryType(title:"👨‍💻 Technology"),
        CategoryType(title: "💖 Non-Profit"),
